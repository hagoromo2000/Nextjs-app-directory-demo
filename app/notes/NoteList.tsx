// 1.フックを用いているため。Client Componentsとして定義
"use client";
...
const NoteItem: React.FC<NoteProps> = ({ item }) => {
  return (
    <div className="bg-gray-100 rounded-lg relative p-5 pt-8">
      {/* ノート編集ページは未実装なため一覧ページに遷移 */}
      <Link href={`/notes`} className="absolute -top-4 left-4">
        <span className="w-8 h-8 inline-flex jusitify-center items-center bg-pink-500 hover:bg-pink-700 text-white rounded-full">
          <svg
